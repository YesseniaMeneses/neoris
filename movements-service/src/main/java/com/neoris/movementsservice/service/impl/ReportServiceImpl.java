...
import com.neoris.movementsservice.constant.Constant;
...
import com.neoris.movementsservice.domain.AccountDetail;
import com.neoris.movementsservice.domain.Filter;
import com.neoris.movementsservice.domain.MovementDetail;
import com.neoris.movementsservice.domain.MovementsByAccount;
import com.neoris.movementsservice.repository.AccountRepository;
import com.neoris.movementsservice.repository.ClientRepository;
import com.neoris.movementsservice.repository.MovementRepository;
import com.neoris.movementsservice.service.ReportService;
...
import static com.neoris.movementsservice.constant.Constant.DEPOSIT_VALUE;
import static com.neoris.movementsservice.constant.Constant.WITHDRAWAL_VALUE;
...
public class ReportServiceImpl implements ReportService {
    ...
    public List<MovementsByAccount> getMovementsByAccount(String dateRange, Long clientId) {
        ...
        if (!accountNumbers.isEmpty()){
            Date startDate = com.neoris.movementsservice.validation.Date.stringToDate(filter.getStartDate());
            Date endDate = com.neoris.movementsservice.validation.Date.stringToDate(filter.getEndDate());
    ...
    private MovementDetail mapToMovementDetail(Movement movement) {
        String date = com.neoris.movementsservice.validation.Date.dateToString(movement.getDate());
    ...
    private Filter mapToFilter(String dateRange, Long clientId) {
        String[] range = com.neoris.movementsservice.validation.Date.validateRangeDate(dateRange);
    ...
    private String evaluateMovementType(Character type) {
        return Constant.DEPOSIT_KEY.equals(type)?DEPOSIT_VALUE:WITHDRAWAL_VALUE;
    }
}
